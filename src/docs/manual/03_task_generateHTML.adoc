...
image::https://img.shields.io/badge/improve-this%20doc-orange.svg[link={manualurl}03_task_generateHTML.adoc, float=right]
...
If you want to control the size of the generated diagram in the output, you can configure the "width" attribute (in pixels) or "scale" attribute (floating point ratio) passed to http://asciidoctor.org/docs/asciidoctor-diagram/[asciidoctor-diagram].
...
[source,groovy]
----
include::../../../docToolchain/scripts/AsciiDocBasics.gradle[tags=generateHTML]
----
