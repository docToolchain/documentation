...
image::https://img.shields.io/badge/improve-this%20doc-orange.svg[link={manualurl}03_task_exportChangeLog.adoc, float=right]
...
[source,groovy]
----
include::../../../docToolchain/scripts/exportChangelog.gradle[tags=exportChangeLog]
----
