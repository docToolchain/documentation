...
image::https://img.shields.io/badge/improve-this%20doc-orange.svg[link={manualurl}03_task_exportVisio.adoc, float=right]
...
[source,groovy]
----
include::../../../docToolchain/scripts/exportVisio.gradle[tags=exportVisio]
----

.scripts/VisioPageToPngConverter.ps1
[source]
----
include::../../../docToolchain/scripts/VisioPageToPngConverter.ps1[]
----
