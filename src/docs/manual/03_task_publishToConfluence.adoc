...
image::https://img.shields.io/badge/improve-this%20doc-orange.svg[link={manualurl}03_task_publishToConfluence.adoc, float=right]
...
[source,groovy]
----
include::../../../docToolchain/scripts/publishToConfluence.gradle[tags=publishToConfluence]
----

.scripts/asciidoc2confluence.groovy
[source,groovy]
----
include::../../../docToolchain/scripts/asciidoc2confluence.groovy[]
----
