...
image::https://img.shields.io/badge/improve-this%20doc-orange.svg[link={manualurl}03_task_exportExcel.adoc, float=right]
...
[source,groovy]
----
include::../../../docToolchain/scripts/exportExcel.gradle[tags=exportExcel]
----
